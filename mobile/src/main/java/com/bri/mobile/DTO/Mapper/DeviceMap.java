...
public class DeviceMap {
    public static DeviceDto toDeviceDto (Device device){
        return DeviceDto.builder()
                ...
                .brand(BrandMap.toBrandDto(device.getBrand()))
                .warranty(device.getWarranty())
                .gifts(GiftMap.toGiftListDto(device.getGifts()))
                .users(UserMap.toUserListDto(device.getUsers()))
    ...
    public static Device toDeviceEntity (DeviceDto deviceDto){
        return Device.builder()
                ...
                .brand(BrandMap.toBrandEntity(deviceDto.getBrand()))
                .warranty(deviceDto.getWarranty())
                .gifts(GiftMap.toGiftListEntity(deviceDto.getGifts()))
                .users(UserMap.toUserListEntity(deviceDto.getUsers()))
